            ...
            {links.map((link) => {
              ...
              return (
                <Link
                  ...
                  href={link.href}
                  className={cn(
                    "cashdesk-nav-link flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium",
                    active
              ...
              {links.map((link) => {
                ...
                return (
                  <Link
                    ...
                    href={link.href}
                    className={cn(
                      "cashdesk-nav-link whitespace-nowrap rounded-md px-3 py-1.5 text-xs font-medium",
